          ...
          >
            <motion.div className="space-y-7" variants={fadeInUp}>
              ...
              <p className="max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl">
                ...
                forbedre tilbagevendende møder gennem enkel, automatisk
                feedback i de værktøjer, de allerede bruger.
              </p>
            </motion.div>
        ...
        >
          <motion.div className="max-w-3xl space-y-4" variants={fadeInUp}>
            ...
            <p className="text-lg leading-8 text-muted-foreground">
              ...
              opstår der et mønster. Derfor starter Lets Grow her: det giver de
              bedste betingelser for at måle kvalitet og følge udviklingen over
              tid.
            </p>
          </motion.div>
        ...
        >
          <motion.div className="max-w-3xl space-y-4" variants={fadeInUp}>
            ...
            <p className="text-lg leading-8 text-muted-foreground">
              ...
              lettere at forbedre over tid. Det er hverken et HR-værktøj eller
              en klassisk surveyplatform.
            </p>
          </motion.div>
        ...
        >
          <motion.div className="max-w-3xl space-y-5" variants={fadeInUp}>
            ...
            <p className="text-lg leading-8 text-white/80">
              Du kan prøve Let&apos;s Grow helt gratis og teste det i praksis.
              Hvis du har lyst til at være blandt de første brugere og give
              feedback undervejs, så vil vi meget gerne have dig med. Målet er
              at gøre tilbagevendende møder mere målbare uden tung opsætning.
            </p>
          </motion.div>
