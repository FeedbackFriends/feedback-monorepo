...
Use this for ICP, market, JTBD, positioning, and prioritization decisions.
...
- people who repeatedly run the same or similar format
- examples: AI workshop holders, coding workshop instructors, internal trainers, facilitators, scrum masters, and team leads with recurring meetings
- they care about comparing sessions over time because they own the format, even when each participant group only attends once

Avoid making the first niche a broad "team app for the office" unless the product strategy is deliberately reset. That direction is harder to explain, harder to activate, and more likely to collide with HR, engagement, and productivity tools.
...
- 3-5 teams during design partner validation
- active usage across 6-8 weeks
- willingness to join feedback calls
- permission to use learnings in future sales material

Best-fit meeting types:
...
- recurring project or operating meetings
- workshops
- presentations or talks
- internal training or facilitated sessions

Strongest early use cases:

- repeatable workshops or training sessions where the owner wants to improve the format
- recurring team or project meetings where the owner wants evidence that changes help
- repeated talks or onboarding sessions where each audience is different but the delivery format improves over time

## Buyer Motivation

The buyer wants a clearer signal about what worked, what did not, and what should change next time.

The emotional context is practical uncertainty: everyone may nod in the room, but the owner does not know what people actually thought. The buyer wants honest feedback without creating extra work.

The core belief behind the wedge:

- What repeats for the owner can be measured.
- What can be measured can improve.
- Recurring meetings should not run on habit alone.
- One-off participant experiences can still create owner learning if the format repeats.
...
The roadmap can be ambitious, but launch positioning must stay narrow.
